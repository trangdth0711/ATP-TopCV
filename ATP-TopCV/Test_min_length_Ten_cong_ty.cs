...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Test_min_length_Ten_cong_ty recording.
    /// </summary>
    [TestModule("c8bdef12-f487-4fb6-9873-968e6273fc9d", ModuleType.Recording, 1)]
    public partial class Test_min_length_Ten_cong_ty : ITestModule
    {
        /// <summary>
        ...
        static Test_min_length_Ten_cong_ty instance = new Test_min_length_Ten_cong_ty();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Test_min_length_Ten_cong_ty()
        {
        }
        ...
        /// </summary>
        public static Test_min_length_Ten_cong_ty Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'tran' with focus on 'ĐăngKyTaiKhoảnNhaTuyểnDụng.TempCompanyName'.", repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.TempCompanyNameInfo, new RecordItemIndex(14));
            repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.TempCompanyName.PressKeys("tran");
            Delay.Milliseconds(0);
