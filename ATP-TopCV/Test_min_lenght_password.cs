...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Test_min_lenght_password recording.
    /// </summary>
    [TestModule("67faefa9-550e-4aea-bcf8-97ada8efba71", ModuleType.Recording, 1)]
    public partial class Test_min_lenght_password : ITestModule
    {
        /// <summary>
        ...
        static Test_min_lenght_password instance = new Test_min_lenght_password();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Test_min_lenght_password()
        {
        }
        ...
        /// </summary>
        public static Test_min_lenght_password Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'trang' with focus on 'ĐăngKyTaiKhoảnNhaTuyểnDụng.Password'.", repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.PasswordInfo, new RecordItemIndex(5));
            repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.Password.PressKeys("trang");
            Delay.Milliseconds(0);
