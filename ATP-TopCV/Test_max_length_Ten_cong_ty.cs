...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Test_max_length_Ten_cong_ty recording.
    /// </summary>
    [TestModule("d97402f7-40cb-4d16-bf8b-d446cf483e53", ModuleType.Recording, 1)]
    public partial class Test_max_length_Ten_cong_ty : ITestModule
    {
        /// <summary>
        ...
        static Test_max_length_Ten_cong_ty instance = new Test_max_length_Ten_cong_ty();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Test_max_length_Ten_cong_ty()
        {
        }
        ...
        /// </summary>
        public static Test_max_length_Ten_cong_ty Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'Công Ty TNHH Huyen Trang Công Ty TNHH Huyen Trang Công Ty TNHH Huyen Trang Công Ty TNHH Huyen Trang Công Ty TNHH Huyen Trang' with focus on 'ĐăngKyTaiKhoảnNhaTuyểnDụng.TempCompanyName'.", repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.TempCompanyNameInfo, new RecordItemIndex(14));
            repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.TempCompanyName.PressKeys("Công Ty TNHH Huyen Trang Công Ty TNHH Huyen Trang Công Ty TNHH Huyen Trang Công Ty TNHH Huyen Trang Công Ty TNHH Huyen Trang");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (InnerText>'Tên công ty từ 5-100 ký tự') on item 'ĐăngKyTaiKhoảnNhaTuyểnDụng.ModalErrorMessage'.", repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.ModalErrorMessageInfo, new RecordItemIndex(16));
            Validate.AttributeContains(repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.ModalErrorMessageInfo, "InnerText", "Tên công ty từ 5-100 ký tự");
