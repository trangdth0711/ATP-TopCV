...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("30d640bf-d7b3-4e87-b479-86c1155f81e8", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'trang2{LShiftKey down}@{LShiftKey up}gmail.com' with focus on 'ĐăngKyTaiKhoảnNhaTuyểnDụng.Email'.", repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.EmailInfo, new RecordItemIndex(1));
            repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.Email.PressKeys("trang2{LShiftKey down}@{LShiftKey up}gmail.com");
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ĐăngKyTaiKhoảnNhaTuyểnDụng.Select2SelectionArrow1' at 7;21.", repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.Select2SelectionArrow1Info, new RecordItemIndex(17));
            repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.Select2SelectionArrow1.Click("7;21");
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ĐăngKyTaiKhoảnNhaTuyểnDụng.Select2GenderResults.LiTagHaNội' at 104;21.", repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.Select2GenderResults.LiTagHaNộiInfo, new RecordItemIndex(18));
            repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.Select2GenderResults.LiTagHaNội.Click("104;21");
            Delay.Milliseconds(200);
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (InnerText>'Tỉnh/thành phố địa điểm làm việc không được để trống') on item 'ĐăngKyTaiKhoảnNhaTuyểnDụng.ModalErrorMessage'.", repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.ModalErrorMessageInfo, new RecordItemIndex(20));
            Validate.AttributeContains(repo.ĐăngKyTaiKhoảnNhaTuyểnDụng.ModalErrorMessageInfo, "InnerText", "Tỉnh/thành phố địa điểm làm việc không được để trống");
